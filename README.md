...
If you FSM begins getting complex, another problem pops up. Take this scenario: a mouse goes out to search cheese ( = starting state), if he found cheese, he returns to his hole, and if the cursor somes to close, he runs away.
